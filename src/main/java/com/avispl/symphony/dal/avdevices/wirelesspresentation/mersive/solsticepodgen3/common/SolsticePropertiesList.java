...
public enum SolsticePropertiesList {
	...
	SCHEDULED_DAILY_REBOOT("ScheduleDailyReboot", SolsticeConstant.EMPTY, true, "m_systemCuration", "scheduledRestartEnabled"),
	REBOOT_TIME_OF_DAY("RebootTimeOfDay", SolsticeConstant.EMPTY, true, "m_systemCuration", "scheduledRestartTime"),
	DISPLAY_NAME("DisplayName", SolsticeConstant.NAMING_AND_DISCOVERY_GROUP, true, "m_displayInformation", "m_displayName"),
	SDS_HOST("SDSHost", SolsticeConstant.NAMING_AND_DISCOVERY_GROUP, false, "m_networkCuration", "sdsHostName"),
	...
	SESSION_KEY("SessionKey", SolsticeConstant.ACCESS_CONTROL_GROUP, false, "m_authenticationCuration", "sessionKey"),
	SCREEN_KEY("ScreenKey", SolsticeConstant.ACCESS_CONTROL_GROUP, true, "m_authenticationCuration", "screenKeyEnabled"),
	MODERATOR_APPROVAL("ModeratorApproval", SolsticeConstant.ACCESS_CONTROL_GROUP, true, "m_authenticationCuration", "moderatorApprovalDisabled"),
	...
	VIDEO_FILES_AND_IMAGES("VideoFilesAndImages", SolsticeConstant.RESOURCE_RESTRICTION_GROUP, true, "m_networkCuration", "postTypeMediaFilesSupported"),
